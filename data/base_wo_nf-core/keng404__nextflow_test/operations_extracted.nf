...
OPERATION_5 string : Channel
    ...
    .set { input_data }
OPERATION_5 origin : [['params.input, size: -1', 'A']]
...
OPERATION_10 string : fished_reads_bai 
    .into {fished_reads_index}
OPERATION_10 origin : [['fished_reads_bai', 'P']]
OPERATION_10 gives  : [['fished_reads_index', 'P']]
