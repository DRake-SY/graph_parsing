...
Outputs : [[0, 'stats_json_file'], [1, 'index_failed_file']]
Emits : []
...
Inputs : [[0, 'ss_sheet'], [1, 'index_failed_file'], [2, 'updated_samplesheet1'], [3, 'problem_samples_list2'], [4, 'resultChannel4']]
...
Outputs : [[0, 'cr_undetermined_default_fq_ch'], [0, 'cr_undetermined_fastqs_screen_ch'], [0, 'cr_undetermined_move_fq_ch mode flatten'], [1, 'cr_fastqs_count_ch'], [1, 'cr_fastqs_copyfs_ch mode flatten'], [2, 'cr_fastqs_fqc_ch'], [2, 'cr_fastqs_screen_ch mode flatten'], [3, 'cr_b2fq_default_reports_ch'], [4, 'cr_b2fq_default_stats_ch']]
Emits : []


Name : cellRangerMoveFqs
Inputs : [[0, 'cr_fastqs_copyfs_tuple_ch'], [1, 'tenx_results2']]
Outputs : []
Emits : []
...
Outputs : [[0, 'fastqs_fqc_ch'], [0, 'fastqs_screen_ch mode flatten'], [1, 'fastqs_idx_ch'], [2, 'undetermined_default_fq_ch'], [2, 'undetermined_default_fastqs_screen_ch mode flatten'], [3, 'undetermined_idx_fq_ch'], [4, 'b2fq_default_reports_ch'], [5, 'b2fq_default_stats_ch']]
Emits : []
...
Name : fastq_screen
Inputs : [[0, 'grouped_fqscreen_ch']]
Outputs : [[0, 'fastq_screen_txt'], [0, 'all_fq_screen_txt_tuple'], [1, 'fastq_screen_html']]
Emits : []


Name : multiqc
Inputs : [[0, 'grouped_fastq_fqscreen_ch']]
Outputs : [[0, 'multiqc_report'], [2, 'projectList']]
Emits : []


Name : multiqcAll
Inputs : [[0, 'all_fcq_files'], [1, 'all_fq_screen_files'], [2, 'b2fq_default_stats_all_ch']]
