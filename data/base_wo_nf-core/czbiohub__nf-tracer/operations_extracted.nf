OPERATION_1 string : Channel
            ...
            .into { read_files_fastqc ; read_files_unzipping }
OPERATION_1 origin : [['params.readPaths', 'V']]
OPERATION_1 gives  : [['read_files_fastqc', 'P'], ['read_files_unzipping', 'P']]
...
OPERATION_2 gives  : [['read_files_fastqc', 'P'], ['read_files_unzipping', 'P']]
...
OPERATION_3 gives  : [['read_files', 'P']]
