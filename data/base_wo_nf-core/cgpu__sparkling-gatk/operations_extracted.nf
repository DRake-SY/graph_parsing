...
OPERATION_29 string : haplotypecaller_index = fasta_haplotypecaller.merge(fai_haplotypecaller, dict_haplotypecaller, indexed_bam_bqsr, intervals_file)
OPERATION_29 origin : [['fasta_haplotypecaller', 'P'], ['fai_haplotypecaller', 'P'], ['dict_haplotypecaller', 'P'], ['indexed_bam_bqsr', 'P'], ['intervals_file', 'P']]
OPERATION_29 gives  : [['haplotypecaller_index', 'P']]


OPERATION_30 string : haplotypecaller = interval.combine(haplotypecaller_index)
OPERATION_30 origin : [['interval', 'P'], ['haplotypecaller_index', 'P']]
OPERATION_30 gives  : [['haplotypecaller', 'P']]


OPERATION_31 string : input_structural_variantcaller = indexed_bam_structural_variantcaller.merge(fasta_structural_variantcaller, fai_structural_variantcaller)
OPERATION_31 origin : [['indexed_bam_structural_variantcaller', 'P'], ['fasta_structural_variantcaller', 'P'], ['fai_structural_variantcaller', 'P']]
OPERATION_31 gives  : [['input_structural_variantcaller', 'P']]


OPERATION_32 string : variant_eval_ref = fasta_variant_eval.merge(fai_variant_eval, dict_variant_eval)
OPERATION_32 origin : [['fasta_variant_eval', 'P'], ['fai_variant_eval', 'P'], ['dict_variant_eval', 'P']]
OPERATION_32 gives  : [['variant_eval_ref', 'P']]


OPERATION_33 string : variant_eval = vcf_variant_eval.combine(variant_eval_ref)
OPERATION_33 origin : [['vcf_variant_eval', 'P'], ['variant_eval_ref', 'P']]
OPERATION_33 gives  : [['variant_eval', 'P']]


OPERATION_34 string : fastqc_multiqc = fastqc_results.collect().ifEmpty([])
OPERATION_34 origin : [['fastqc_results', 'P']]
OPERATION_34 gives  : [['fastqc_multiqc', 'P']]


OPERATION_35 string : multiqc_data = markdup_multiqc.merge(fastqc_multiqc, baseRecalibratorReport, variantEvalReport, bamQCmappedReport, bamQCrecalibratedReport)
OPERATION_35 origin : [['markdup_multiqc', 'P'], ['fastqc_multiqc', 'P'], ['baseRecalibratorReport', 'P'], ['variantEvalReport', 'P'], ['bamQCmappedReport', 'P'], ['bamQCrecalibratedReport', 'P']]
OPERATION_35 gives  : [['multiqc_data', 'P']]


OPERATION_36 string : multiqc = bcftools_multiqc.combine(multiqc_data)
OPERATION_36 origin : [['bcftools_multiqc', 'P'], ['multiqc_data', 'P']]
OPERATION_36 gives  : [['multiqc', 'P']]


OPERATION_37 string : multiqc = bcftools_multiqc.combine(variantEvalReport.merge(bamQCrecalibratedReport))
OPERATION_37 origin : [['bcftools_multiqc', 'P'], ['bamQCrecalibratedReport', 'P']]
OPERATION_37 gives  : [['multiqc', 'P']]
