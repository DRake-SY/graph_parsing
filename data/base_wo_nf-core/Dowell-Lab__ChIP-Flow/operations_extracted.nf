...
OPERATION_9 gives  : [['sorted_bams_for_preseq', 'P'], ['sorted_bams_for_rseqc', 'P'], ['sorted_bams_for_dreg_prep', 'P'], ['sorted_bams_for_pileup', 'P'], ['sorted_bams_for_picard', 'P'], ['sorted_bam_for_bedgraph', 'P']]
...
OPERATION_10 gives  : [['sorted_bam_indicies_for_pileup', 'P'], ['sorted_bam_indices_for_preseq', 'P'], ['sorted_bam_indices_for_rseqc', 'P'], ['sorted_bam_indices_for_picard', 'P'], ['sorted_bam_index_for_bedgraph', 'P']]
