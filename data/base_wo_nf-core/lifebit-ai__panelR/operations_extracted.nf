...
OPERATION_8 string : ch_grouped_pop_vcfs = ch_pops_vcfs.groupTuple(by: 0)
OPERATION_8 origin : [['ch_pops_vcfs', 'P']]
OPERATION_8 gives  : [['ch_grouped_pop_vcfs', 'P']]


OPERATION_9 string : ch_plink_count_freqs_to_inspect.view()
OPERATION_9 origin : [['ch_plink_count_freqs_to_inspect', 'P']]
OPERATION_9 gives  : []
