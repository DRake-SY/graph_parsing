...
Outputs : [[0, 'haplotypecaller_gvcf'], [1, 'index'], [2, 'sample']]
Emits : []


Name : MergeVCFs
Inputs : [[0, 'haplotypecaller_gvcf'], [1, 'index'], [2, 'sample']]
Outputs : [[0, 'vcf_bcftools'], [0, 'vcf_variant_eval']]
Emits : []


Name : StructuralVariantCallers
Inputs : [[0, 'input_structural_variantcaller']]
Outputs : [[0, 'output_structural_variantcaller']]
Emits : []
...
Name : VariantEval
Inputs : [[0, 'variant_eval']]
Outputs : [[0, 'variantEvalReport']]
Emits : []
