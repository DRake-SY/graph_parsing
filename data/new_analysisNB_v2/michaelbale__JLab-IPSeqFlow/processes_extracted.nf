...
Name : filterPrimaryAlnSE
Inputs : [[0, 'params'], [1, 'bt2Bam_ch']]
Outputs : [[0, 'idxstats_ch'], [1, 'picardDupStats_ch'], [2, 'finalBam_ch'], [3, 'forPCA_ch'], [3, 'forBEPImage_ch'], [4, 'names_ch']]
Emits : []
...
Name : multiqcSE
Inputs : [[0, 'fastqc_ch'], [0, 'idxstats_ch'], [0, 'picardDupStats_ch'], [0, 'trimmomaticLogs_ch'], [0, 'bt2Logs_ch']]
Outputs : []
Emits : []
...
Inputs : [[0, 'params'], [1, 'bt2Bam_ch']]
Outputs : [[0, 'idxstats_ch'], [1, 'picardISStats_ch'], [2, 'picardDupStats_ch'], [3, 'finalBam_ch'], [4, 'forPCA_ch'], [4, 'forBEPImage_ch'], [5, 'names_ch']]
Emits : []
