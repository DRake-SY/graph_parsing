...
OPERATION_2 string : compareLines = Channel.from("two_groups")
OPERATION_2 origin : [['"two_groups"', 'V']]
...
OPERATION_16 string : Channel
    ...
    .set{ results_arrange }
OPERATION_16 origin : [['quantification_results', 'P'], ['motif_results_for_report', 'P'], ['diffm6A_results', 'P'], ['htseq_results', 'P'], ['anno_for_diffreport', 'P'], ['prediction_results', 'P'], ['bed_collect_for_arrange_results', 'P'], ['multiqc_results', 'P'], ['deseq2_results', 'P'], ['edgeR_results', 'P'], ['', 'V']]
